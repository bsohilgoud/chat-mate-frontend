    ...
    <AnimatePresence>
      {showProfile && (
        <motion.div
          ...
          className={`${showProfile ? "flex" : "hidden"}  sp-header-container absolute z-1000 w-full
        md:max-w-[400px] flex-col h-full md:min-w-[400px] bg-[var(--secondary-color)]
        border-l-[0.5px] border-l-[var(--border-color)] shadow-[0px_0px_20px_0px_rgba(0,0,0,0.19)] px-4 py-3 right-0 `}
        >
          ...
          <div className="sp-header-text text-5xl text-center">
            Contact Info
          </div>
